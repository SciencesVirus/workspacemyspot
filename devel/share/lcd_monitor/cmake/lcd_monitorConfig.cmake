...
if("TRUE" STREQUAL "TRUE")
  set(lcd_monitor_SOURCE_PREFIX /home/virus/workspace/src/lcd_monitor)
  set(lcd_monitor_DEVEL_PREFIX /home/virus/workspace/devel)
  ...
  set(lcd_monitor_INSTALL_PREFIX /home/virus/workspace/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lcd_monitor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/virus/workspace/src/lcd_monitor/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND lcd_monitor_EXPORTED_TARGETS ${${lcd_monitor_dep}_EXPORTED_TARGETS})
endforeach()
